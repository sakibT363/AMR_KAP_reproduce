#Table-6:Factors associated with the level of practices among parents of school-going children (N=704)
...
data$Practice_Level<-factor(data$Practice_Level, levels = c("Good", "Misuse"))
